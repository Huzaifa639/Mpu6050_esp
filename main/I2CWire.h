...
#define SCL           GPIO_NUM_21     /*!< GPIO number used for I2C master clock */
#define SDA           GPIO_NUM_22     /*!< GPIO number used for I2C master data  */
...
private:
    bool is_slave;
    i2c_config_t I2C_config[SOC_I2C_NUM];
    void (*user_onRequest)(void);
    void (*user_onReceive)(int);
    static void onRequestService(uint8_t, void *);
    static void onReceiveService(uint8_t, uint8_t*, size_t, bool, void *);
    bool initPins(int, int sdaPin, int sclPin);
    bool allocateWireBuffer(void);
    void freeWireBuffer(void);
    esp_err_t i2c_bus_init(int num, int sda, int scl, int frequency);
    int i2cGetClock(int num, uint32_t * frequncy);
    int i2cSetClock(int num, uint32_t frequency);
...
public:
    ...
    inline bool begin()
    {
        return begin(-1, -1, static_cast<uint32_t>(100000));
    }
